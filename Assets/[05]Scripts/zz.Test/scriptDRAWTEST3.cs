...
public class scriptDRAWTEST3 : Graphic
{
    ...
    protected UIVertex[] SetVboMesh(VertexHelper vboMesh, Vector2[] vertices, Vector2[] uvs)
    {
    ...
    protected override void OnPopulateMesh(Mesh AMesh)
    {
        ...
        AMesh.Clear();
        var AvboMesh = new VertexHelper(AMesh);
        ...
        for (int i = 1; i < TempPoints.Length; i++)
        {
            ...
            float angle =  Mathf.Atan2(cur.y - prev.y, cur.x - prev.x) * 180f / Mathf.PI;
                ...
                if (i > 1)
                    SetVboMesh(AvboMesh, new[] { prevV1, prevV2, v1, v2 }, uvs);
                ...
                AvboMesh.AddUIVertexQuad(SetVboMesh(AvboMesh, new[] { v1, v2, v3, v4 }, uvs));

                AvboMesh.FillMesh(AMesh);
