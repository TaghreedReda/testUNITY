...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlayer : MonoBehaviour
	{
		...
		public bool OpenVideoFromFile(FileLocation location, string path, bool autoPlay = true, float startMs = 0.0f)
		{
